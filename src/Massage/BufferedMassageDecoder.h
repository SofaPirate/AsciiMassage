#ifndef BufferedMassageDecoder_h
#define BufferedMassageDecoder_h

#include "MassageDecoder.h"

class BufferedMassageDecoder : public MassageDecoder {
public:
  /// Constructor.
  BufferedMassageDecoder()  {
    flush();
  }

  // Virtual destructor.
  virtual ~BufferedMassageDecoder() {}
...
public:
  ...
  char buffer[MASSAGE_DECODER_BUFFERSIZE];
};
